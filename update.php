        ...
        <form action="" method="post">
            ...
            ?>
                ...
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="" value="Frontend " name="brands[]" <?php if (in_array('Frontend ', $ex)) {
                                                                                                                echo 'checked';
                                                                                                            } ?> />
                    <label class="form-check-label" for="">Frontend </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="" value="Backend " name="brands[]" <?php if (in_array('Backend ', $ex)) {
                                                                                                                echo 'checked';
                                                                                                            } ?> />
                    <label class="form-check-label" for="">Backend </label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="checkbox" id="" value="Ui/Ux Designer" name="brands[]" <?php if (in_array('Ui/Ux Designer', $ex)) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?> />
